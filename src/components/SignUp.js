  ...
  const handleSubmit = async (e) => {
    ...
    if (phoneRegex.test(phone)) {
      ...
      if (isVerified) {
        ...
        const res = await fetch("https://mbackend-lilac.vercel.app/register", {
          method: "POST",
          headers: {
        ...
        try {
          const res = await fetch("https://mbackend-lilac.vercel.app/verifyOTP", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
        ...
        try {
          const res = await fetch("https://mbackend-lilac.vercel.app/sendOTP", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
      ...
      if (isVerified) {
        ...
        try {
          ...
          const res = await fetch("https://mbackend-lilac.vercel.app/send-email", {
            method: "POST",
